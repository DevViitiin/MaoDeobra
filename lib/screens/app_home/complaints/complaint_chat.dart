import 'package:dartobra_new/services/services_complaint/service_complaint_chat.dart';
...
class _ComplaintChatState extends State<ComplaintChat>
  ...
  // ── State ─────────────────────────────────────────────────────────────────
  int     _currentStep   = 0; // 0 = motivo | 1 = gravidade | 2 = descrição
  ...
  // ── Dados ─────────────────────────────────────────────────────────────────
  static const _accent = Color(0xFFDC2626); // red-600

  final List<_ReasonOption> _reasons = [
    _ReasonOption('Spam',                       Icons.mark_email_unread_outlined),
    _ReasonOption('Mensagens indesejadas',       Icons.block_outlined),
    _ReasonOption('Assédio ou bullying',         Icons.sentiment_very_dissatisfied_outlined),
    _ReasonOption('Conteúdo inadequado',         Icons.hide_image_outlined),
    _ReasonOption('Conteúdo ofensivo',           Icons.warning_amber_outlined),
    _ReasonOption('Discurso de ódio',            Icons.record_voice_over_outlined),
    _ReasonOption('Golpe ou fraude',             Icons.gpp_bad_outlined),
    _ReasonOption('Partilhar informações falsas',Icons.fact_check_outlined),
    _ReasonOption('Ameaças ou violência',        Icons.personal_injury_outlined),
    _ReasonOption('Conteúdo sexual não solicitado', Icons.no_adult_content_outlined),
    _ReasonOption('Violação de privacidade',     Icons.lock_open_outlined),
  ...
  final List<_SeverityOption> _severities = [
    _SeverityOption('Leve',  'Incômodo pontual sem dano grave',   Color(0xFFF59E0B), Icons.sentiment_neutral_outlined),
    _SeverityOption('Média', 'Comportamento recorrente ou dano moderado', Color(0xFFF97316), Icons.sentiment_dissatisfied_outlined),
    _SeverityOption('Grave', 'Situação urgente ou risco real',    Color(0xFFDC2626), Icons.sentiment_very_dissatisfied_outlined),
  ];
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          _buildStepHeader(
            'Qual é o motivo?',
            'Selecione a opção que melhor descreve o problema.',
          ),
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 10),
              Text(
                'Nossa equipe vai analisar o caso em breve. Obrigado por ajudar a manter a plataforma segura.',
