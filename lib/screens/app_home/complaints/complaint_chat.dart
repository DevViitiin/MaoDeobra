...
class ComplaintChat extends StatefulWidget {
  ...
  @override
  State<ComplaintChat> createState() => _ChatReportScreenState();
}

class _ChatReportScreenState extends State<ComplaintChat> {
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 16),
                    _buildModernInfoRow(Icons.chat_bubble_outline, 'ID do Chat', widget.chatId),
              ...
              Container(
                ...
                child: DropdownButtonFormField<String>(
                  ...
                  decoration: InputDecoration(
                    ...
                    prefixIcon: Icon(Icons.speed, color: Colors.orange.shade400),
