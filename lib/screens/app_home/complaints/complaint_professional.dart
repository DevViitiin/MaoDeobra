import 'package:dartobra_new/services/services_complaint/service_complaint_professional.dart';
import 'package:flutter/material.dart';

class ComplaintProfessional extends StatefulWidget {
  final String vacancyId;
  final String reportId;
  final String reportedId;

  const ComplaintProfessional({
    Key? key,
  ...
  @override
  State<ComplaintProfessional> createState() => _ComplaintProfessionalState();
}

class _ComplaintProfessionalState extends State<ComplaintProfessional>
  ...
  final List<_ReasonOption> _reasons = [
    _ReasonOption('Comportamento inadequado',      Icons.person_off_outlined),
    _ReasonOption('Usuario menor de idade',        Icons.lock),
    _ReasonOption('Perfil falso ou fraude',        Icons.gpp_bad_outlined),
    _ReasonOption('Informações enganosas',         Icons.info_outline),
    _ReasonOption('Usuario menor de idade',        Icons.lock),
    _ReasonOption('Assédio ou discriminação',      Icons.do_not_disturb_alt_outlined),
    ...
    _ReasonOption('Qualificações falsas',          Icons.workspace_premium_outlined),
    _ReasonOption('Profissional não compareceu',   Icons.event_busy_outlined),
    _ReasonOption('Cobrança indevida',             Icons.money_off_outlined),
    _ReasonOption('Perfil duplicado',              Icons.copy_all_outlined),
  ...
  final List<_SeverityOption> _severities = [
    ...
    _SeverityOption('Grave', 'Fraude ou risco real ao contratante',   Color(0xFFDC2626), Icons.sentiment_very_dissatisfied_outlined),
  ];
              ...
              if (i.isOdd) {
                ...
                return Expanded(
                  child: AnimatedContainer(
                    ...
                    height: 2,
                    decoration: BoxDecoration(
                      color: stepIndex < _currentStep ? _accent : Colors.grey.shade200,
          ...
          Container(
            ...
            child: TextField(
              ...
              decoration: InputDecoration(
                hintText: 'Explique com detalhes o problema encontrado com o profissional...',
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 10),
              Text(
                'Nossa equipe vai analisar o perfil em breve. Obrigado por manter a plataforma segura.',
