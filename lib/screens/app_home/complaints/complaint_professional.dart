...
class ComplaintVacancy extends StatefulWidget {
  ...
  @override
  State<ComplaintVacancy> createState() => _JobReportScreenState();
}

class _JobReportScreenState extends State<ComplaintVacancy> {
  ...
  final List<String> _reportReasons = [
    'Vaga falsa ou fraudulenta',
    'Informações enganosas',
    'Requisitos discriminatórios',
    'Salário não informado',
    'Fotos inapropriadas',
    'Empresa não existe',
    'Golpe ou pirâmide financeira',
    'Conteúdo ofensivo',
    'Vaga duplicada',
  ...
  void _submitReport() {
    if (_formKey.currentState!.validate()) {
      ...
      // Todos os campos preenchidos - salvar em variáveis
      final String vacancyId = widget.vacancyId;
      final String reportId = widget.reportId;
      final String reportedId = widget.reportedId;
      final String reason = _selectedReason!;
      final String severity = _selectedSeverity!;
      final String description = _descriptionController.text.trim();

      // Chamar a função create_complaint
      create_complaint(
        vacancyId: vacancyId,
        reportId: reportId,
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 16),
                    _buildModernInfoRow(Icons.work_outline, 'ID da Vaga', widget.vacancyId),
                    const SizedBox(height: 12),
                    _buildModernInfoRow(Icons.assignment_outlined, 'ID da Denúncia', widget.reportId),
                    const SizedBox(height: 12),
                    _buildModernInfoRow(Icons.person_outline, 'ID do Denunciado', widget.reportedId),
                  ],
                ),
              ),
              const SizedBox(height: 24),
              ...
              Container(
                ...
                child: DropdownButtonFormField<String>(
                  ...
                  decoration: InputDecoration(
                    ...
                    prefixIcon: Icon(Icons.list_alt, color: Colors.orange.shade400),
              ...
              Container(
                ...
                child: TextFormField(
                  ...
                  decoration: InputDecoration(
                    ...
                    filled: true,
                    fillColor: Colors.white,
                    hintText: 'Descreva detalhadamente o problema com a vaga...',
